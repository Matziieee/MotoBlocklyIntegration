...
+   '<block type="settilecolourcountdown">'
+     '<field name="speed">S</field>'
+   '</block>'
+   '<block type="get_player_score">'
+     '<field name="score">0</field>'
+   '</block>'
+ '</category>'
+ '<category name="Experimental" colour="#a5745b">'
+   '<block type="setexpectednextpress"></block>'
+   '<block type="tileset">'
+     '<field name="tile">1</field>'
+     '<field name="boolean">A</field>'
+   '</block>'
+ '</category>'
