...
+ '</category>'
+ '<category name="Control" colour="#097B10">'
+   '<block type = "waiter"></block>'
+   '<block type = "repeat"></block>'
+ '</category>'
+ '<category name="Presses" colour="#097B10">'
+   '<block type = "step"></block>'
+   '<block type = "stepRed"></block>'
+   '<block type = "stepBlue"></block>'
+   '<block type = "stepGreen"></block>'
+   '<block type = "stepIndigo"></block>'
+ '</category>'
+ '<category name="Score" colour="#097B10">'
+   '<block type = "minusScore"></block>'
+   '<block type = "plusScore"></block>'
+ '</category>'
+ '<category name="Sound" colour="#097B10">'
+   '<block type = "animalSound"></block>'
+ '</category>'
+'</xml>';
